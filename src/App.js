		...
		<div>
            ...
            className="small"
                ...
                Audio
					...
					>
						Audio Technica - Mulai Dari <span className="red">Rp 910rb</span>
					</Card>
				</Col>
        <Col m={3}>
					<Card
            className="small"
                ...
                Handphone
					...
					>
						Handphone Samsung - Mulai Dari <span className="red">Rp 200rb</span>
					</Card>
				</Col>
        <Col m={3}>
					<Card
        ...
        <Col m={3}>
            ...
            className="small"
                ...
                Koleksi The Avenger
					...
					>
						Koleksi The Avenger - Mulai Dari <span className="red">Rp 10rb</span>
					</Card>
				</Col>
			</Row>
		</div>
